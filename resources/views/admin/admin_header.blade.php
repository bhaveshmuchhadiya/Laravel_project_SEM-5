            ...
            <ul class="list-unstyled components">
                ...
                <li>
                    ...
                    <ul class="collapse list-unstyled" id="homeSubmenu">
                        ...
                        <li>
                            <a href="view_department">Manage Department</a>
                        </li>
                    </ul>
                </li>
                <li>
                    ...
                    <ul class="collapse list-unstyled" id="pageSubmenu1">
                        <li>
                            <a href="add_leave">Add Leave_type</a>
                        </li>
                        <li>
                            <a href="view_leave_type">Manage Leave_type</a>
                        </li>
                    </ul>
                </li>
                <li>
                    ...
                    <ul class="collapse list-unstyled" id="pageSubmenu2">
                        ...
                        <li>
                            <a href="view_employee">Manage Employee</a>
                        </li>
                    </ul>
                </li>
                <li>
                    ...
                    <ul class="collapse list-unstyled" id="pageSubmenu3">
                        ...
                        <li>
                            <a href="pandding_leaves">Panding Leaves</a>
                        </li>
                        <li>
