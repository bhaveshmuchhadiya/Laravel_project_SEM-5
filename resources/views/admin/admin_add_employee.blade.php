        ...
        <form action="#" method="post"><div class="form-row">
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-4">
                    ...
                    <input type="Date" class="form-control" name="birth_date" placeholder="Password" required="">
                </div>
            </div>
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-5">
                    ...
                    <input type="number" class="form-control" name="mnumber" placeholder="1234567890" required="">
                </div>
            </div>
            <div class="form-row">
                <div class="form-group col-md-4">
